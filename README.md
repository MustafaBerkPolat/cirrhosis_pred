# Cirrhosis Stage Prediction with Machine Learning
...
|-----|-------------|-------------|--------------|------------|-------------|----------|------------|-----|------------|------------|---------------|-----------|-------------|-----------|
|count|   418.000000|   418.000000|    418.000000|  418.000000|   284.000000|418.000000|  310.000000|count|  312.000000|  312.000000|     282.000000| 407.000000|   416.000000| 412.000000|  
|mean |   209.500000|  1917.782297|  18533.351675|    3.220813|   369.510563|  3.497440|   97.648387|mean | 1982.655769|  122.556346|     124.702128| 257.024570|    10.731731|   3.024272|  
|std  |   120.810458|  1104.672992|   3815.845055|    4.407506|   231.944545|  0.424972|   85.613920|std  | 2140.388824|   56.699525|      65.148639|  98.325585|     1.022000|   0.882042|  
|min  |     1.000000|    41.000000|   9598.000000|    0.300000|   120.000000|  1.960000|    4.000000|min  |  289.000000|   26.350000|      33.000000|  62.000000|     9.000000|   1.000000|  
|25%  |   105.250000|  1092.750000|  15644.500000|    0.800000|   249.500000|  3.242500|   41.250000|25%  |  871.500000|   80.600000|      84.250000|  62.000000|     9.000000|   1.000000|  
|50%  |   209.500000|  1730.000000|  18628.000000|    1.400000|   309.500000|  3.530000|   73.000000|50%  | 1259.000000|  114.700000|     108.000000| 188.500000|    10.000000|   2.000000|  
|75%  |   313.750000|  2613.500000|  21272.500000|    3.400000|   400.000000|  3.770000|  123.000000|75%  | 1980.000000|  151.900000|     151.000000| 251.000000|    10.600000|   3.000000|  
|max  |   418.000000|  4795.000000|  28650.000000|   28.000000|  1775.000000|  4.640000|  588.000000|max  |13862.400000|  457.250000|     598.000000| 721.000000|    18.000000|   4.000000|  

At a first glance at the pair plots of our numerical data, there aren't any strong correlations or clustering to take into immediate consideration. Looking closely at the ID column, we can see that there is a very clear cut-off line for the N-Days column where its upper bound somewhat linearly decreases with ID until roughly the 300 ID mark, but then it resets and starts linearly decreases again, and past this 300-ID line we have no data for some of the columns like Cholesterol, Copper and Alk_Phos. This is in line with the dataset description mentioning that the first 312 participants contain more complete data whereas the remaining 106 did not participate in the clinical trial of the drug D-penicillamine, only giving consent to basic measurements. This can cause our predictions to be biased or be performed with incomplete information, but given the size of the dataset, I chose not to exclude the last 106 participants.
...
As this is a classification problem, the following models were used:
 - Random forest with 'balanced subsample' class weights
 - Gradient boosting (XGBoost)
 - Support vector machine classification with probability estimates
 - Logistic regression with l2 penalty terms, regularization strength of 1 and liblinear solver (which outperformed all other solvers in initial testing)
 - K-nearest neighbors
 - Decision tree
 - Adaptive boosting
 - Gaussian naive Bayes

Additionally, all the models were also used as the meta-learner for a stacking classifier model, which excluded the meta-learners as initial learners for themselves. 

Models were trained with a stratified 10-fold cross validation method, with a one-hot encoding of categorical columns as well as standard scaling and power transforming of numerical columns. In the end, the models' performances were as follows:
...
And when used as a meta-learner:
...
![Log Loss and Recall](https://github.com/user-attachments/assets/ab828a75-d75c-4c08-b867-93c68f9c6e51)
